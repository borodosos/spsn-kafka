...
return [
    ...
    'topics' => match (env('APP_ENV')) {
        'production' => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'stable-ticket-srv',
        ...
        'stage' => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'stage-ticket-srv',
        ...
        'dev_custom' => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'dever-ticket-srv',
        ...
        default => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'dev-ticket-srv',
    ...
    'usernames' => match (env('APP_ENV')) {
        'production' => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'kuser-td-stable-ticket-srv',
        ...
        'stage' => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'kuser-td-stage-ticket-srv',
        ...
        default => [
            ...
            SpsnAppServiceNames::SPSN_TICKETS => 'kuser-td-dev-ticket-srv',
