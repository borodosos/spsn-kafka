...
return [
    'main_service_url'         => env('MAIN_SERVICE_URL', 'http://localhost:80'),
    'notification_service_url' => env('NOTIFICATION_SERVICE_URL', 'http://localhost:81'),
    'billing_service_url'      => env('BILLING_SERVICE_URL', 'http://localhost:82'),
    'tickets_service_url'       => env('TICKETS_SERVICE_URL', 'http://localhost:83'),
    ...
    'web_frontend_service_url' => env('WEB_FRONTEND_SERVICE_URL', 'http://localhost:89'),
];
